//! Public-API smoke tests confirming the crate's surface compiles
//! and runs independently of any host emulator.

use ppc::{
    PPC_MSR_FP_AVAILABLE_MASK, PpcCpu, PpcException, PpcFetchHistogram, PpcFetchedInstruction,
    PpcIllegalInstructionReason, PpcImportAction, PpcInstr, PpcMemory, PpcMemoryAccess,
    PpcRunResult, PpcSectionMem, decode,
};
